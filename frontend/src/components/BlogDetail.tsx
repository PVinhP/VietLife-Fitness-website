...
const BlogDetail = () => {
    ...
    return (
        <div className="text-white min-h-screen">
            ...
            <div className="w-full bg-gray-900 py-4 mb-8">
                <div className="w-4/5 m-auto flex items-center">
                    ...
                    <nav className="text-gray-400 text-sm">
                        ...
                        <span className="text-white">{blog.tieu_de}</span>
                    </nav>
                </div>
            </div>
            ...
            <div className="w-4/5 m-auto">
                <article className="max-w-4xl mx-auto">
                    ...
                    <header className="mb-8">
                        ...
                        {blog.tom_tat && (
                            <div className="text-xl text-gray-300 italic leading-relaxed mb-8 p-4 bg-gray-800 rounded-lg border-l-4 border-blue-500">
                    ...
                    {/* Blog content */}
                    <div className="prose prose-lg prose-invert max-w-none text-gray-300 leading-relaxed text-lg">
                        <ReactMarkdown 
                            ...
                            components={{
                                ...
                                blockquote: ({children}) => (
                                    <blockquote className="border-l-4 border-blue-500 pl-4 italic text-gray-400 my-4 bg-gray-800 p-4 rounded">
                                        {children}
                                    </blockquote>
                                ),
                                code: ({children}) => (
                                    <code className="bg-gray-800 px-2 py-1 rounded text-sm text-blue-400">{children}</code>
                                ),
                                pre: ({children}) => (
                                    <pre className="bg-gray-800 p-4 rounded overflow-x-auto mb-4">{children}</pre>
                                )
                            }}
                        >
                            {blog.noi_dung}
                    ...
                    <section className="mt-16 pt-8 border-t border-gray-700">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            {relatedBlogs.map((relatedBlog) => (
                                <div 
                                    key={relatedBlog.id}
                                    className="bg-gray-800 rounded-lg overflow-hidden cursor-pointer hover:shadow-xl transition-all duration-300 hover:scale-105"
                                ...
                                >
                                    ...
                                    />
                                    <div className="p-4">
                                        <h3 className="font-bold text-lg mb-2 line-clamp-2 hover:text-blue-400 transition-colors">
                                            {relatedBlog.tieu_de}
                                        </h3>
