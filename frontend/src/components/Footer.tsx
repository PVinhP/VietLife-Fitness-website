    ...
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
              <a href="/" className="flex items-center">
                  ...
                  <span className="self-center text-2xl font-semibold whitespace-nowrap text-white">VietLife</span>
              </a>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  ...
                  <ul className="text-gray-400 font-medium">
                      <li className="mb-4">
                          <a href="/" className="hover:underline">VietLife</a>
                      </li>
                      <li>
              ...
              <div>
                  ...
                  <ul className="text-gray-400 font-medium">
                      <li className="mb-4">
                          <a href="https://github.com/PVinhP/VietLife-Fitness-website" className="hover:underline ">Github</a>
                      </li>
                      <li>
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
              ...
              <a href="https://www.instagram.com/vinhpham7032/" className="text-gray-500 hover:text-white">
