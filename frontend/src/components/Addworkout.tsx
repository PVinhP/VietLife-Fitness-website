  ...
  return (
    <div >
      <div className=" p-8 flex flex-wrap md:flex-nowrap justify-between">
        <div className="mt-8">
          <img src="https://images.pexels.com/photos/1431283/pexels-photo-1431283.jpeg?auto=compress&amp;cs=tinysrgb&amp;w=1260&amp;h=750&amp;dpr=1" className="w-full lg:max-w-2xl mx-auto" alt="ảnh minh họa" />
        </div>
      ...
      <div onClick={() => navigate("/expert")}>
        <img style={{ float: 'right', width: "87px", fontSize: "70px", marginRight: "-18%", position: "absolute", top: "70%", left: "93.3%" }} src={bot} alt="ảnh minh họa" />
      </div>
    </div>
  )
}
