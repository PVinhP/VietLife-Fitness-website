      ...
      <div className='w-10/12  m-auto mt-10'>
        ...
        <div className='flex m-10 '>
          ...
          <div>
            ...
            <h1 className='text-white'>VietLife transform is the epitome of cheating and looting. Horrible product with absolutely no value adds whatsoever. The only good thing going for Cult is their sales team. Having said that, it is the most shamelessly dishonest sales team I have ever encountered.</h1>
          </div>
        ...
        <div className='flex  m-10'>
          ...
          <div>
            ...
            <h1 className='text-white'>I've been using VietLife for a few months now, and overall, I've had a positive experience with the app. The workouts are challenging but not overwhelming, and I appreciate the variety of classes offered, from yoga to HIIT to strength training.</h1>
          </div>
        </div>
      </div>
