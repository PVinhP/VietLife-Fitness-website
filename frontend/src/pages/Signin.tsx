    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        axios.post(`https://curious-bat-jewelry.cyclic.app/user/login`, formdata)
            .then((res) => {
                ...
                localStorage.setItem("VietLifeuser", res.data.username)
                // alert(res.data.msg)
        ...
        <div className="flex items-center justify-center min-h-screen  text-black" >
            ...
            >
                ...
                <div className="flex flex-col justify-center p-8 md:p-14 text-white">
                    <span className="mb-3 text-4xl font-bold text-center ">Welcome back to VietLife</span>
                ...
                <div className="relative">
                    ...
                    >
                        ...
                        >"Don’t give up on your dreams,<br /> or your dreams will give up on you." <br /> Be VietLife!!
                        </span>
                    </div>
                </div>
            </div >
