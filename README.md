...
* 📊 **Personalization Engine:** Tự động tính toán chỉ số y học vận động (BMI, TDEE) và dựa vào mục tiêu, thông tin sức khỏe đầu vào AI sẽ phân tích và đề xuất lộ trình tập luyện và dinh dưỡng cá nhân hóa phù hợp.
